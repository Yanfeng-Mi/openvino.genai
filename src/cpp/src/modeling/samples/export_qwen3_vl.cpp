...
/// @file export_qwen3_vl.cpp
/// @brief Sample: Export a HuggingFace Qwen3-VL model as VLMPipeline-compatible
///        OpenVINO IR files.
///
/// Usage:
///   export_qwen3_vl <MODEL_DIR> <OUTPUT_DIR> [TEXT_QUANT] [TEXT_GS] [TEXT_BACKUP] [VISION_QUANT] [VISION_GS] [VISION_BACKUP]
///
/// Arguments:
...
int main(int argc, char* argv[]) {
    ...
    ov::genai::modeling::models::Qwen3VLExportOptions options;
    ...
    std::cout << "=== Qwen3-VL VLMPipeline Export ===\n"
              << "  Model:   " << model_dir << "\n"
              << "  Output:  " << output_dir << "\n"
    ...
    ov::genai::modeling::models::export_qwen3_vl_for_vlmpipeline(
